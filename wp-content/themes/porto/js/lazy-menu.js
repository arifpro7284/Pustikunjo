			...
			if ( menu_type ) {
				...
				var menu_loaded_fn = function( data ) {
					...
					if ( typeof $el == 'object' && $el.length ) {
						...
						if ( $el.find('[data-vc-tabs]').length ) {
							if ( typeof $.fn.vcTabs != 'undefined' ) {
								$el.find('[data-vc-tabs]').vcTabs();
							} else {
								var script = document.createElement('script');
								script.src = js_porto_vars.vc_tabs_url; // adjust path
								script.type = 'text/javascript';
								script.onload = function() {
									$el.find('[data-vc-tabs]').vcTabs();
								} // optional: run something after loaded
