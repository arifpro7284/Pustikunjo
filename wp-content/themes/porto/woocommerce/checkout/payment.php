...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<?php if ( WC()->cart && WC()->cart->needs_payment() ) : ?>
		...
		<ul class="wc_payment_methods payment_methods methods px-2" aria-label="<?php esc_attr_e( 'Payment methods', 'woocommerce' ); ?>">
			<?php
	...
	<div class="form-row place-order">
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<div class="' . esc_attr( $add_class ) . '"><button type="submit" class="button alt btn-v-dark w-100 mt-3 py-3" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">'. esc_html( $order_button_text ) .'</button></div>' ); // @codingStandardsIgnoreLine ?>
