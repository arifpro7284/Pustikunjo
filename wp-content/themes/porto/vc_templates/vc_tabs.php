...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, trim( $element . $el_class ), $this->getSettings()['base'] );
...
if ( vc_is_inline() ) {
	$output    .= '<div class="' . ( 'vc_tour' === $this->getShortcode() ? 'wpb_tour' : 'wpb_tabs' ) . ' wpb_content_element">';
