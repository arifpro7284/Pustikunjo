 ...
 */
$css  = $css_animation = '';
// the preset color param was dropped in WPBakery 9.0, the accent color is used instead.
$color = '';
$atts = vc_map_get_attributes( $this->getShortcode(), $atts );
extract( $atts );

// 9.0 turned the border width into a range param whose value can carry its px unit.
