...
$disable_element = '';
$output          = $after_output = '';
// WPBakery 9.0 renamed the section content_placement param to vertical_content_position.
$vertical_content_position = '';
$atts            = vc_map_get_attributes( $this->getShortcode(), $atts );
extract( $atts );

if ( empty( $content_placement ) && ! empty( $vertical_content_position ) ) {
	$content_placement = $vertical_content_position;
}
