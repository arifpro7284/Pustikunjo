...
if ( $porto_settings['share-whatsapp'] ) :
	...
	if ( wp_is_mobile() ) :
	?>
	<a href="whatsapp://send?text=<?php echo rawurlencode( $permalink ); ?>" <?php echo porto_filter_output( $nofollow . $tooltip ); ?> title="<?php esc_attr_e( 'WhatsApp', 'porto' ); ?>" class="share-whatsapp<?php echo ! $wishlist_page ? '' : ' whatsapp'; ?>"><?php esc_html_e( 'WhatsApp', 'porto' ); ?></a>
	<?php else : ?>

	<a href="https://api.whatsapp.com/send?text=<?php echo rawurlencode( $permalink ); ?>" <?php echo porto_filter_output( $extra_attr ); ?> title="<?php esc_attr_e( 'WhatsApp', 'porto' ); ?>" class="share-whatsapp<?php echo ! $wishlist_page ? '' : ' whatsapp'; ?>"><?php esc_html_e( 'WhatsApp', 'porto' ); ?></a>
	<?php
	endif;
endif;

if ( ! empty( $porto_settings['share-viber'] ) ) :
	?>
	<a href="viber://forward?text=<?php echo porto_filter_output( $permalink ); ?>" <?php echo porto_filter_output( $extra_attr ); ?> title="<?php esc_attr_e( 'Viber', 'porto' ); ?>" class="share-viber" aria-label="<?php esc_attr_e( 'Viber', 'porto' ); ?>"><?php esc_html_e( 'Viber', 'porto' ); ?></a>
	<?php
endif;
