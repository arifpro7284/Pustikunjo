...
function porto_search_form_content( $is_mobile = false ) {
	...
	<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get"
		...
		<div class="searchform-fields<?php echo ( 'overlay' == $porto_settings['search-layout']  && ! $is_mobile ? ' container' : '' ); ?>">
			...
			<?php if ( isset( $porto_settings['search-type'] ) && ( 'page' === $porto_settings['search-type'] || 'event' === $porto_settings['search-type'] || 'post' === $porto_settings['search-type'] || 'product' === $porto_settings['search-type'] || 'portfolio' === $porto_settings['search-type'] || 'faq' === $porto_settings['search-type'] ) ) : ?>
...
function porto_header_socials( $el_class = '' ) {
	...
	if ( $porto_settings['header-social-whatsapp'] ) :
		?>
		<a target="_blank" <?php echo porto_filter_output( $nofollow ); ?> class="share-whatsapp" href="<?php echo esc_url( $porto_settings['header-social-whatsapp'] ); ?>" aria-label="<?php esc_attr_e( 'WhatsApp', 'porto' ); ?>" title="<?php esc_attr_e( 'WhatsApp', 'porto' ); ?>"></a>
		<?php
	endif;
