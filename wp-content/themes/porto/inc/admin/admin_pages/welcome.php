		...
		<div class="welcome col-left">
			<div class="porto-section">
				<div class="porto-important-notice registration-form-container">
					...
					<?php else : ?>
						<p class="about-description"><?php esc_html_e( 'Please enter your ThemeForest purchase code or Porto license key to complete registration.', 'porto' ); ?></p>
					<?php endif; ?>
					<div class="porto-registration-form">
						<form id="porto_registration" method="post" class="system-status">
							...
							<?php else : ?>
								<input type="text" name="code" class="regular-text" value="<?php echo esc_attr( $purchase_code ); ?>" placeholder="<?php esc_attr_e( 'ThemeForest purchase code or Porto license key', 'porto' ); ?>"<?php echo porto_filter_output( $disable_field ); ?> />
								<?php if ( Porto()->is_registered() ) : ?>
						...
						<?php endif; ?>
						<div style="margin-top: 10px;"><?php printf( esc_html__( 'For Themeforest purchase code, please login to %1$ssupport site%2$s and can reset your license %3$shere%2$s from current site domain.', 'porto' ), '<a href="https://www.portotheme.com/support/">', '</a>', '<a href="https://www.portotheme.com/support/reset-sites/">' ); ?></div>
						<div style="margin-top: 5px;"><?php printf( esc_html__( 'For Porto License key, please go to %1$sMy Account -> My Themes%2$s page in %3$sPortoTheme.com%4$s to reset your license from current site.', 'porto' ), '<strong>', '</strong>', '<a href="https://www.portotheme.com/" target="_blank">', '</a>' ); ?></div>
						<p><?php esc_html_e( 'Where can I find my purchase code or license key?', 'porto' ); ?></p>
						<p><strong><?php esc_html_e( 'ThemeForest (Envato)', 'porto' ); ?></strong></p>
						<ol>
						...
						<p><strong><?php esc_html_e( 'PortoTheme.com', 'porto' ); ?></strong></p>
						<ol>
							...
							<li><?php esc_html_e( 'Copy your Porto license key and paste it in the field above.', 'porto' ); ?></li>
						</ol>
					</div>
				</div>
