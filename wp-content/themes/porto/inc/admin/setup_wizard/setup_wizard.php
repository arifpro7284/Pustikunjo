...
if ( ! class_exists( 'Porto_Theme_Setup_Wizard' ) ) {
	...
	class Porto_Theme_Setup_Wizard {
		...
		public function porto_demo_types() {
			...
			return array(
				'classic'              => array(
					'alt'        => 'Main Demo <small>(6 VARIATIONS)</small>',
					'slider_cat' => 'classic',
				...
				'shop'                 => array(
					'alt'        => 'Shop Demo <small>(56 VARIATIONS)</small>',
					'slider_cat' => 'shop',
				...
				'accounting2'       => array(
					'alt'     => 'Accounting 2',
					'img'     => $demo_img_site . '/demos/accounting2.jpg',
					'filter'  => 'business all elementor soft has-badge badge-new',
					'plugins' => array( 'js_composer', 'contact-form-7' ),
				),
				'shop56'       => array(
					'alt'     => 'Shop 56',
					'img'     => $demo_img_site . '/demos/shop56.jpg',
					'filter'  => 'shop elementor soft has-badge badge-new',
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation' ),
				),
				'accounting'       => array(
					'alt'     => 'Accounting',
	...
	/*			'corporate2'           => array(
		...
		/*		'corporate13'          => array(
				...
				'shop54'               => array(
					...
					'filter'  => 'shop elementor soft has-badge badge-new',
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation', 'wpc-buy-now-button' ),
				),
				'shop53'               => array(
					'alt'     => 'Shop 53',
				...
				'shop52'               => array(
					...
					'filter'  => 'shop elementor soft has-badge badge-new',
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation', 'yith-woocommerce-frequently-bought-together' ),
				),
				'shop51'               => array(
					'alt'     => 'Shop 51',
				...
				'shop49'               => array(
					...
					'filter'  => 'shop elementor soft',
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation', 'yith-woocommerce-compare' ),
				),
				'shop48'               => array(
					'alt'     => 'Shop 48',
					'img'     => $demo_img_site . '/demos/shop48.jpg',
					'filter'  => 'shop elementor soft',
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation', 'wpc-buy-now-button', 'yith-woocommerce-frequently-bought-together' ),
				),
				'shop47'               => array(
					'alt'     => 'Shop 47',
				...
				'shop22'               => array(
					...
					'filter'  => 'shop elementor',
					'plugins' => array( 'js_composer', 'woocommerce', 'dokan-lite', 'yith-woocommerce-wishlist', 'contact-form-7', 'yith-woocommerce-ajax-navigation' ),
				),
				'shop22-wcfm'          => array(
				...
				'shop27'               => array(
					...
					'filter'  => 'shop elementor',
					'plugins' => array( 'js_composer', 'woocommerce', 'instagram-slider-widget', 'yith-woocommerce-wishlist', 'contact-form-7', 'yith-woocommerce-ajax-navigation' ),
				),
				'shop28'               => array(
				...
				'shop31'               => array(
					...
					'filter'  => 'shop elementor',
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'yith-woocommerce-frequently-bought-together', 'yith-woocommerce-ajax-navigation' ),
				),
				'shop34'               => array(
					'alt'     => 'Shop 34',
		...
		public function init_wizard_steps() {
			...
			if ( class_exists( 'Porto_Soft_Mode' ) ) {
				$this->steps['fse_mode'] = array(
					'name'    => esc_html__( 'Builder & AI Key', 'porto' ),
		...
		public function enqueue() {
			...
			// Demo-install flow: styled "remove before install" prompt (replaces the
			// native confirm) + auto-remove. See assets/js/demo-install-flow.js.
			wp_enqueue_style( 'porto-demo-install-flow', PORTO_URI . '/inc/admin/setup_wizard/assets/css/demo-install-flow.css', array( 'porto-setup' ), $this->version );
			wp_enqueue_script( 'porto-demo-install-flow', PORTO_URI . '/inc/admin/setup_wizard/assets/js/demo-install-flow.js', array( 'porto-setup' ), $this->version, true );
		}
		...
		public function porto_setup_wizard_demo_content() {
			...
			<p><?php esc_html_e( 'In this step, you can upload your logo and select a demo to install.', 'porto' ); ?></p>
				...
				<div class="porto-logo-title-row">
					<div class="porto-logo-col">
						<h4><?php esc_html_e( 'Upload Your Logo:', 'porto' ); ?></h4>
						<div class="porto-field-card porto-logo-card">
							<div id="current-logo" class="porto-logo-preview">
							<?php
							...
							if ( ! isset( $porto_settings['logo-type'] ) || ! $porto_settings['logo-type'] ) {
								...
								if ( $image_url ) {
									printf( '<img class="site-logo" src="%s" alt="%s" style="max-width:%spx; height:auto" />', esc_url( $image_url ), esc_attr( get_bloginfo( 'name' ) ), esc_attr( $logo_width ) );
								}
							} else {
								?>
								<input type="text" name="new_logo_text" id="new_logo_text" class="porto-field-input" value="<?php echo esc_attr( $porto_settings['logo-text'] ); ?>">
								<?php
							}
							?>
							</div>
							<?php if ( ! isset( $porto_settings['logo-type'] ) || ! $porto_settings['logo-type'] ) : ?>
							<a href="#" class="btn btn-dark btn-sm button-upload"><?php esc_html_e( 'Upload Logo', 'porto' ); ?><i class="fas fa-upload ms-2"></i></a>
							<?php
							/**
							 * Inside the logo card (image-logo only). Used by the AI
							 * module to render the "Generate Logo" button.
							 */
							do_action( 'porto_ai_logo_actions' );
							?>
							<?php endif; ?>
							<p class="porto-field-hint"><i class="fas fa-info-circle"></i> <?php esc_html_e( 'You can upload and customize this in Theme Options later.', 'porto' ); ?></p>
						</div>
					</div>
					<?php
					/**
					 * After the logo section — renders the Website Title column (right
					 * side of the row) via the AI module. See class-ai-ui.php.
					 */
					do_action( 'porto_ai_after_logo_section' );
					?>
				</div>
				<?php
				// Confirmation popup shown before importing when demo content is
				// already installed. Behavior wired in assets/js/demo-install-flow.js.
				?>
				<div class="porto-confirm-install porto-setup-wizard mfp-hide">
					<h4><?php esc_html_e( 'Remove installed demo first?', 'porto' ); ?></h4>
					<p><?php esc_html_e( 'You already have demo content installed. We recommend removing it before importing a new demo so their contents don\'t mix.', 'porto' ); ?></p>
					...
					<div class="porto-confirm-actions">
						<button type="button" class="btn btn-primary btn-confirm-remove"><?php esc_html_e( 'Remove first, then install', 'porto' ); ?></button>
						<button type="button" class="btn btn-dark btn-confirm-skip"><?php esc_html_e( 'No, just install', 'porto' ); ?></button>
					</div>
				</div>
				...
				<?php
				/**
				 * Before the demo grid on the Demo Content step.
				 * Used by the AI module to render the demo assistant intro/banner.
				 */
				do_action( 'porto_ai_before_demo_grid' );
				?>
		...
		public function porto_setup_wizard_updates() {
			...
			<?php else : ?>
				<p class="lead"><?php esc_html_e( 'Enter your ThemeForest purchase code or Porto license key.', 'porto' ); ?></p>
					<?php
					...
					if ( Porto()->is_registered() ) {
						if ( ! empty( $errors ) ) {
							echo '<div class="notice-warning notice-alt"><p>' . esc_html__( 'License was not updated. We will keep the existing one.', 'porto' ) . '</p></div>';
						} else {
							/* translators: $1 and $2 opening and closing strong tags respectively */
							echo '<div class="notice-success notice-alt notice-large" style="margin-bottom:15px!important">' . sprintf( esc_html__( 'Your %1$slicense is valid%2$s. Thank you! Enjoy Porto Theme and automatic updates.', 'porto' ), '<strong>', '</strong>' ) . '</div>';
						}
					...
					if ( ! Porto()->is_registered() ) {
						...
						?>
							<div style="margin-top: 10px;"><?php echo sprintf( esc_html__( 'For Themeforest purchase code, please login to %1$ssupport site%2$s and can reset your license %3$shere%2$s from current site domain.', 'porto' ), '<a href="https://www.portotheme.com/support/">', '</a>', '<a href="https://www.portotheme.com/support/reset-sites/">' ); ?></div>
							<div style="margin-top: 5px; margin-bottom: 10px;"><?php printf( esc_html__( 'For Porto License key, please go to %1$sMy Account -> My Themes%2$s page in %3$sPortoTheme.com%4$s to reset your license from current site.', 'porto' ), '<strong>', '</strong>', '<a href="https://www.portotheme.com/" target="_blank">', '</a>' ); ?></div>
							<p style="margin-bottom: 0;"><?php esc_html_e( 'Where can I find my purchase code or license key?', 'porto' ); ?></p>
							<p style="margin-bottom: 10px;"><strong><?php esc_html_e( 'ThemeForest (Envato)', 'porto' ); ?></strong></p>
							<ol>
							...
							<p style="margin-bottom: 10px;"><strong><?php esc_html_e( 'PortoTheme.com', 'porto' ); ?></strong></p>
							<ol>
								<li><?php printf( esc_html__( 'Go to %1$sPortoTheme.com%2$s and log in to your account, or check your purchase confirmation email.', 'porto' ), '<a target="_blank" href="https://www.portotheme.com/" rel="noopener noreferrer">', '</a>' ); ?></li>
								<li><?php esc_html_e( 'Copy your Porto license key and paste it in the field below.', 'porto' ); ?></li>
							</ol>
						<?php
						echo '<input type="hidden" name="porto_registration" /><input type="hidden" name="action" value="register" />' .
								'<input type="text" id="porto_purchase_code" name="code" value="' . esc_attr( $purchase_code ) . '" placeholder="' . esc_attr__( 'ThemeForest purchase code or Porto license key', 'porto' ) . '" class="w-50" style="padding:10px;"' . porto_filter_output( $disable_field ) . '/><br/>' .
								'<p class="porto-setup-actions step">' .
						...
						echo '<form action="" method="post">';
						wp_nonce_field( 'porto-setup' );
						echo '<input type="hidden" name="porto_registration" /><input type="hidden" name="action" value="unregister" />' .
								'<input type="text" id="porto_purchase_code" name="code" value="' . esc_attr( $purchase_code ) . '" placeholder="' . esc_attr__( 'ThemeForest purchase code or Porto license key', 'porto' ) . '" class="w-50" style="padding:10px;"' . porto_filter_output( $disable_field ) . '/><br/>' .
								'<p class="porto-setup-actions step">' .
								'<button type="submit" class="btn button-next btn-dark">' . esc_attr__( 'Deactivate', 'porto' ) . '<i class="fas fa-chevron-right ms-2"></i></button>' .
								'<a href="' . esc_url( $this->get_next_step_link() ) . '" class="btn btn-primary button-next">' . esc_html__( 'Next Step', 'porto' ) . '<i class="fas fa-chevron-right ms-2"></i></a>' .
								'</p></form>';
					}
					?>
				<?php
		...
		public function porto_setup_wizard_fse_mode() {
			...
			<p class="notice-warning notice-alt" style="font-size: 14px;padding: 5px 10px;"><?php esc_html_e( 'In Full Site Editing(Builder Mode), you can use only template builders to full-site edit. Theme options and metaboxes that are unnecessary and overridden are removed. You will be no longer disturbed from complicated relationships of options.', 'porto' ); ?></p>
			<form action="" method="post">
				<ul>
					<li>
						<label class="checkbox checkbox-inline">
							<input type="checkbox" value="true" name="soft_mode" <?php echo isset( $porto_settings_optimize['legacy_mode'] ) ? checked( $porto_settings_optimize['legacy_mode'], false, false ) : ''; ?>/> <?php esc_html_e( 'Activate Full Site Editing (Builder Mode)', 'porto' ); ?>
						</label>
						<p><?php esc_html_e( 'If you are developing a new site, it is highly recommended to activate Porto Builder mode or import a Full Site Editing (FSE) demo to get the most out of our design system and prebuilt layouts. If you are upgrading an existing site to Full Site Editing, make sure to backup your database and theme options first, as many of your current settings may be overwritten during the transition.', 'porto' ); ?></p>
					</li>
				</ul>

				<h2 style="margin-top: 2rem"><?php esc_html_e( 'Porto AI — OpenAI API Key', 'porto' ); ?> <span style="font-size: .75rem; color: #08c; font-weight: 600; vertical-align: middle;"><?php esc_html_e( '(Recommended)', 'porto' ); ?></span></h2>
				<div style="border: 1px solid #cbe0f1; background: #f3f9fd; border-radius: 8px; padding: 16px 20px; font-size: 14px;">
					<p style="margin-top: 0;"><?php esc_html_e( 'Porto includes AI-powered features. In the next “Demo Content” step, the AI Demo Assistant recommends the best demo for your business, and you can keep using AI to build pages and generate content as you grow your site. To enable these features, add your own OpenAI API key:', 'porto' ); ?></p>
					<ol style="margin: 0 0 .75rem 1.25rem; padding: 0;">
						<li style="margin-bottom: .5rem;">
							<?php printf( wp_kses( __( 'Open the %1$sOpenAI API keys page%2$s and sign in (or create a free account).', 'porto' ), array( 'a' => array( 'href' => array(), 'target' => array(), 'rel' => array() ) ) ), '<a href="https://platform.openai.com/account/api-keys" target="_blank" rel="noopener noreferrer">', '</a>' ); ?>
						</li>
						<li style="margin-bottom: .5rem;">
							<?php echo wp_kses( __( 'Click <em>Create new secret key</em>, name it (e.g. “Porto”), then copy the generated key — it starts with <code>sk-</code>. For security, OpenAI shows the full key only once.', 'porto' ), array( 'em' => array(), 'code' => array() ) ); ?>
						</li>
						<li style="margin-bottom: .5rem;">
							<?php echo wp_kses( __( 'In your WordPress dashboard, go to <strong>Porto → Theme Options → General → AI Features</strong>.', 'porto' ), array( 'strong' => array() ) ); ?>
						</li>
						<li>
							<?php echo wp_kses( __( 'Paste the key into the <strong>OpenAI API Key</strong> field and click <strong>Save Changes</strong>.', 'porto' ), array( 'strong' => array() ) ); ?>
						</li>
					</ol>
					<p style="margin-bottom: 0;"><i class="fas fa-info-circle" style="color: #08c;"></i> <?php echo wp_kses( __( 'Recommended model: <strong>GPT-5.4 Mini</strong> — the best balance of speed, cost, and quality for demo recommendations and content. Make sure billing is enabled on your OpenAI account so the key can access it. You can skip this now and add the key later from Theme Options at any time.', 'porto' ), array( 'strong' => array() ) ); ?></p>
				</div>
			...
			if ( current_user_can( 'manage_options' ) ) {
				...
				if ( defined( 'RS_REVISION' ) ) {
					...
					if ( isset( $demos[ $demo ]['revslider'] ) && ! empty( $demos[ $demo ]['revslider'] ) ) {
						...
						$demo_path = $this->get_demo_file();
						if ( version_compare( RS_REVISION, '7.0.0', '>=' ) ) {
							if ( ! class_exists('RevSliderSliderImport' ) ) {
								require_once WP_PLUGIN_DIR . '/revslider/admin/includes/slider.class.php';
								require_once WP_PLUGIN_DIR . '/revslider/admin/includes/slider-import.class.php';
							}

							$import = new RevSliderSliderImport();
							foreach ( $demos[ $demo ]['revslider'] as $rev ) {

								if ( false !== strpos( $rev, '-v6.zip' ) ) {
									continue;
								}

								$result = $import->import_slider( true, $demo_path . '/' . $rev );
							...
							foreach ( $demos[ $demo ]['revslider'] as $rev ) {
								...
								$rev = str_replace( '.zip', '-v6.zip', $rev );
		...
		private function import_after_functions( $demo ) {
			...
			if ( 'shortcodes' != $demo ) {
				...
				} elseif ( false !== strpos( $demo, 'accounting2' ) ) {
					$posts_page = $this->importer_get_page_by_title( 'Insights' );
				} else {
				...
				if ( 0 === strpos( $demo, 'elementor-' ) ) { // Elementor demo
					...
					if ( $post_query->have_posts() ) {
						foreach ( $post_query->posts as $post ) {
							...
							// If Elementor & WPBakery both activate,
							delete_post_meta( $post->ID, '_elementor_page_assets' );
							delete_post_meta( $post->ID, '_elementor_data' );
							delete_post_meta( $post->ID, '_elementor_edit_mode' );
							delete_post_meta( $post->ID, 'porto_elementor_page_assets_saved' );
...
// Porto AI Setup-Wizard assistant: demo recommendation + website title generator.
// Registers the porto/v1/ai/* REST routes (admin-only). See ai/docs/worker-contract.md.
