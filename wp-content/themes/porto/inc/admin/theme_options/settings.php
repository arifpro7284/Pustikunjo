			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						'id'       => 'ai-gpt-key',
						'type'     => 'text',
						'title'    => __( 'OpenAI API Key', 'porto' ),
						'subtitle' => sprintf( __( 'You can get your API Key in your %1$sOpenAI Acount%2$s.', 'porto' ), '<a href="https://platform.openai.com/account/api-keys" target="_blank">', '</a>' ),
						'default'  => '',
					),
				),
			);
