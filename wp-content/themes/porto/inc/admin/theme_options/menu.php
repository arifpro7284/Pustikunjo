...
$this->sections[] = array(
	...
	'fields'     => array(
		...
		array(
			...
			'subtitle'  => sprintf( __( 'Please change the search content type on %1$sTheme Options > Header > Search Form > Search Content Type%2$s. Determines whether to put a search box in the mobile menu.', 'porto' ), '<b style="color: #222">', '</b>' ),
			'required'  => array( 'mobile-panel-type', 'equals', array( 'side' ) ),
			'default'   => true,
			'on'        => __( 'Yes', 'porto' ),
			'off'       => __( 'No', 'porto' ),
