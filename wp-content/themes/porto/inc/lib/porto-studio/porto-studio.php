				...
				if ( class_exists( 'RevSlider' ) ) {
					...
					if ( $demo_file_path && ! is_wp_error( $demo_file_path ) ) {
						...
						if ( version_compare( RS_REVISION, '7.0.0', '>=' ) ) {
							...
							$result = $import->import_slider( true, $demo_file_path . '/' . $posts['revslider'][1] );
						} else {
							$slider   = new RevSlider();
							$imported = $slider->importSliderFromPost( true, false, $demo_file_path . '/' . str_replace( '.zip', '-v6.zip', $posts['revslider'][1] ) );
						}
