		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'raw'             => sprintf( esc_html__( 'Please add the Menu on %6$sAppearance > Menus%2$s. And change the %1$sMenu Type%2$s.%3$s%3$s Please %4$ssave and refresh%5$s the page after %4$schanging%5$s the menu type on %4$stheme options%5$s.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'menu-type' ) . '" target="_blank">', '</a>', '<br/>', '<b>', '</b>', '<a href="' . admin_url( 'nav-menus.php' ) . '" target="_blank">' ),
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				array(
					...
					'selector' => '#header .elementor-element-{{ID}} .porto-wide-sub-menu a, .elementor-element-{{ID}} .elementor-heading-title, #header .elementor-element-{{ID}} .porto-narrow-sub-menu a, .elementor-element-{{ID}} .sidebar-menu .popup, .elementor-element-{{ID}} .porto-popup-menu .sub-menu, #header .elementor-element-{{ID}} .top-links .narrow li.menu-item>a',
				)
			);
