	...
	protected function render() {
		...
		if ( class_exists( 'Woocommerce' ) ) {
			...
			if ( function_exists( 'porto_account_menu' ) ) {
				...
				echo '<a href="' . esc_url( wc_get_page_permalink( 'myaccount' ) ) . '" aria-label="' . esc_attr__( 'My Account', 'porto-functionality' ) . '" title="' . esc_attr__( 'My Account', 'porto-functionality' ) . '" class="my-account"><i class="' . esc_attr( $icon_cl ) . '"></i></a>';
			}
