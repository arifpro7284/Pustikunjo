		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				array(
					...
					'selector' => '.elementor-element-{{ID}} .widget-compare .compare',
				)
			);
			$this->add_control(
				'icon_size',
				array(
					...
					'selectors'  => array(
						'.elementor-element-{{ID}} .widget-compare .compare:before' => 'font-size: {{SIZE}}{{UNIT}};',
					),
				)
			);
			$this->add_control(
				...
				array(
					...
					'selectors'  => array(
						'.elementor-element-{{ID}} .widget-compare .compare' => 'height: auto; padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
				)
			);
			$this->add_control(
				...
				array(
					...
					'selectors'  => array(
						'.elementor-element-{{ID}} .widget-compare .compare' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					),
				)
			);			
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						array(
							...
							'selectors' => array(
								'.elementor-element-{{ID}} .widget-compare .compare' => 'color: {{VALUE}};',
							),
						)
					);
					$this->add_control(
						...
						array(
							...
							'selectors' => array(
								'.elementor-element-{{ID}} .widget-compare .compare' => 'border-color: {{VALUE}};',
							),
						)
					);
					$this->add_control(
						...
						array(
							...
							'selectors' => array(
								'.elementor-element-{{ID}} .widget-compare .compare' => 'background-color: {{VALUE}};',
							),
						)
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						array(
							...
							'selectors' => array(
								'.elementor-element-{{ID}} .widget-compare .compare:hover' => 'color: {{VALUE}};',
							),
						)
					);
					$this->add_control(
						...
						array(
							...
							'selectors' => array(
								'.elementor-element-{{ID}} .widget-compare .compare:hover' => 'border-color: {{VALUE}};',
							),
						)
					);
					$this->add_control(
						...
						array(
							...
							'selectors' => array(
								'.elementor-element-{{ID}} .widget-compare .compare:hover' => 'background-color: {{VALUE}};',
							),
						)
					);
				$this->end_controls_tab();
