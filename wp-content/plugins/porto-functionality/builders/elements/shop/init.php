...
if ( ! class_exists( 'PortoBuildersShop' ) ) :
	class PortoBuildersShop {
					...
					function( $atts, $content = null ) use ( $tag ) {
						...
						if ( 'products' == $tag && is_singular( PortoBuilders::BUILDER_SLUG ) ) {
							...
							if ( 'toggle' == $tag ) {
								...
								$params_keys = array( 'pagination_hide', 'pag_space', 'label_hide', 'select_hide', 'label_color', 'label_typography', 'select_color', 'select_typography', 'select_padding', 'spacing', 'select_padding', 'select_height' );
							} elseif ( 'products' == $tag ) {
								$params_keys = array( 'dots_pos_top', 'dots_pos_bottom', 'dots_pos_left', 'dots_pos_right', 'dots_abr_color', 'dots_bg_color', 'dots_abg_color', 'dots_original', 'dots_visible', 'nav_visible', 'nav_fs', 'nav_width', 'nav_height', 'nav_br', 'navs_h_origin', 'nav_h_pos', 'nav_v_pos', 'nav_color', 'nav_h_color', 'nav_bg_color', 'nav_h_bg_color', 'nav_br_color', 'nav_h_br_color', 'flick_opacity', 'spacing' );
							}
							$params = array();
							...
							if ( defined( 'VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG' ) && isset( $atts['css_design'] ) ) {
								$shortcode_class .= apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class( $atts['css_design'], ' ' ), 'porto_sb_' . $tag, $atts );
							}
							$internal_css = PortoShortcodesClass::generate_wpb_css( trim( $shortcode_name ), $atts );
		...
		public function load_wpb_map_elements() {
			...
			vc_map(
				array(
					'name'         => __( 'Tool Box (including Pagination)', 'porto-functionality' ),
				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								__( 'Default', 'porto-functionality' ) => '',
								__( 'Show', 'porto-functionality' )    => 'inline-block',
								__( 'Hide', 'porto-functionality' )    => 'none',
							),
							'description' => sprintf( esc_html__( 'Label is hidden as default if you select the %1$sFilter Layout from Horizontal Filters%2$s on the %3$sTheme Option%4$s. It is shown on the %3$sOther Layouts%4$s', 'porto-functionality' ),  '<a href="' .  esc_url( porto_get_theme_option_url( 'product-archive-filter-layout' ) ) . '" target="_blank">', '</a>', '<b>', '</b>' ),
							'selectors'   => array(
								'{{WRAPPER}} .woocommerce-ordering label' => 'display: {{VALUE}};',
							),
						),
						array(
							'type'        => 'colorpicker',
			...
			vc_map(
				array(
					'name'        => __( 'Pagination ( Count Per Page )', 'porto-functionality' ),
					'base'        => 'porto_sb_count',
					'icon'        => PORTO_WIDGET_URL . 'count-per-page.png',
					'class'       => 'porto-wpb-widget',
					'category'    => __( 'Shop Builder', 'porto-functionality' ),
					'as_child'    => array( 'only' => 'porto_sb_toolbox' ),
					'description' => __( 'This shows pagination depending on the shop products count when pagination option is disabled in Type Builder Archives element.', 'porto-functionality' ),
					'params'      => array(
						array(
							'type'       => 'porto_param_heading',
						...
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Pagination Visibility', 'porto-functionality' ),
							'param_name' => 'pagination_hide',
							'value'      => array(
								__( 'Default', 'porto-functionality' ) => '',
								__( 'Show', 'porto-functionality' )    => 'inline-block',
								__( 'Hide', 'porto-functionality' )    => 'none',
							...
							'selectors'  => array(
								'{{WRAPPER}} .page-numbers' => 'vertical-align: top; display: {{VALUE}} !important;',
								'{{WRAPPER}} li a, {{WRAPPER}} li span' => 'margin-bottom: 0;',
							),
						),
						array(
							'type'        => 'porto_number',
							'heading'     => __( 'Left Space', 'porto-functionality' ),
							'description' => __( 'Spacing Between Pagination and Select Box', 'porto-functionality' ),
							'param_name'  => 'pag_space',
							'units'       => array( 'px', 'rem' ),
							'selectors'   => array(
								'{{WRAPPER}} ul.page-numbers' => "margin-{$left}: {{VALUE}}{{UNIT}};",
							),
							'dependency'  => array(
								'element'            => 'pagination_hide',
								'value_not_equal_to' => 'none',
							),
						),
						array(
				...
				array(
					...
					'params'      => array(
						...
						array(
							...
							'param_name'  => 'clr',
							'selectors'   => array(
								'{{WRAPPER}} a:not(.active)' => 'color: {{VALUE}}; border-color: {{VALUE}};',
							),
							'group'      => __( 'Style', 'porto-functionality' ),
						),
						array(
							...
							'selectors'   => array(
								'{{WRAPPER}} .active' => 'color: {{VALUE}}; border-color: {{VALUE}};',
							),
							'group'      => __( 'Style', 'porto-functionality' ),
						),
