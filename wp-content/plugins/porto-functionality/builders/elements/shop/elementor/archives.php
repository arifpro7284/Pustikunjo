...
class Porto_Elementor_SB_Archives_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'load_more_keep_url',
			array(
				'label'       => esc_html__( 'Preserve the page number in the URL', 'porto-functionality' ),
				'description' => esc_html__( 'Enable this option to update the page number in the URL when new products are loaded.', 'porto-functionality' ),
				'type'        => Controls_Manager::SWITCHER,
				'condition'   => array(
					'pagination_style' => array( 'infinite', 'load_more' ),
				),
				'default'     => '',
			)
		);
