...
?>
	<li>
		<a role="button" aria-label="<?php esc_attr_e( 'Open Lightbox', 'porto-functionality' ); ?>" href="<?php echo esc_url( $lightbox ? $zoom_image1_url : $link1 ); ?>" class="diamond" title="<?php echo esc_attr( $title1 ); ?>">
			<div class="content">
	...
	<li>
		<a role="button" aria-label="<?php esc_attr_e( 'Open Lightbox', 'porto-functionality' ); ?>" href="<?php echo esc_url( $lightbox ? $zoom_image2_url : $link2 ); ?>" class="diamond" title="<?php echo esc_attr( $title2 ); ?>">
			<div class="content">
	...
	<li>
		<a role="button" aria-label="<?php esc_attr_e( 'Open Lightbox', 'porto-functionality' ); ?>" href="<?php echo esc_url( $lightbox ? $zoom_image3_url : $link3 ); ?>" class="diamond" title="<?php echo esc_attr( $title3 ); ?>">
			<div class="content">
	...
	<li>
		<a role="button" aria-label="<?php esc_attr_e( 'Open Lightbox', 'porto-functionality' ); ?>" href="<?php echo esc_url( $lightbox ? $zoom_image4_url : $link4 ); ?>" class="diamond diamond-sm" title="<?php echo esc_attr( $title4 ); ?>">
			<div class="content">
	...
	<li>
		<a role="button" aria-label="<?php esc_attr_e( 'Open Lightbox', 'porto-functionality' ); ?>" href="<?php echo esc_url( $lightbox ? $zoom_image5_url : $link5 ); ?>" class="diamond" title="<?php echo esc_attr( $title5 ); ?>">
			<div class="content">
	...
	<li>
		<a role="button" aria-label="<?php esc_attr_e( 'Open Lightbox', 'porto-functionality' ); ?>" href="<?php echo esc_url( $lightbox ? $zoom_image6_url : $link6 ); ?>" class="diamond diamond-sm" title="<?php echo esc_attr( $title6 ); ?>">
			<div class="content">
	...
	<li>
		<a role="button" aria-label="<?php esc_attr_e( 'Open Lightbox', 'porto-functionality' ); ?>" href="<?php echo esc_url( $lightbox ? $zoom_image7_url : $link7 ); ?>" class="diamond diamond-sm" title="<?php echo esc_attr( $title7 ); ?>">
			<div class="content">
