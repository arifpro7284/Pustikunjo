...
$output                         .= '<div class="floating-menu ' . esc_attr( $el_class ) . '">';
	$output                     .= '<div class="floating-menu-body">';
		$output                 .= '<div class="floating-menu-row">';
			$output             .= '<button aria-label="Collapse the floating menu item" class="btn floating-menu-btn-collapse-nav" data-bs-toggle="collapse" data-bs-target=".floating-menu-nav-main">';
