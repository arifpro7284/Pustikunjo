...
if ( isset( $settings['link_source'] ) && 'dynamic' == $settings['link_source'] && ! empty( $settings['link_dynamic_content'] ) && ! empty( $settings['link_dynamic_content']['source'] ) ) {
	$field_name = '';
	if ( 'post' == $settings['link_dynamic_content']['source'] ) {
		if ( isset( $settings['link_dynamic_content']['post_info'] ) ) {
			$field_name = $settings['link_dynamic_content']['post_info'];
		}
	} else {
		if ( isset( $settings['link_dynamic_content'][ $settings['link_dynamic_content']['source'] ] ) ) {
			$field_name = $settings['link_dynamic_content'][ $settings['link_dynamic_content']['source'] ];
		}
	}
	if ( $field_name ) {
		$settings['link'] = apply_filters( 'porto_dynamic_tags_content', '', null, $settings['link_dynamic_content']['source'], $field_name );
	}
	if ( 'metabox' ==  $settings['link_dynamic_content']['source'] && 'member_phone' ==  $settings['link_dynamic_content']['metabox'] ) {
		$settings['link'] = str_replace( '+', '', $settings['link'] );
		$settings['link'] = str_replace( ' ', '', $settings['link'] );
		$settings['link'] = 'tel:' . $settings['link'];
	}
}
