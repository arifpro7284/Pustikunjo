<?php
/**
 * Porto Dynamic Term Meta Field Tags class
 *
 * @author     P-THEMES
 * @version    2.3.0
 */
...
class Porto_El_Custom_Field_Term_Meta_Tag extends Elementor\Core\DynamicTags\Tag {

	public function get_name() {
		return 'porto-custom-field-term-meta';
	}
	...
	protected function register_controls() {
		 ...
		 * Add term meta field
		 */
		do_action( 'porto_dynamic_el_extra_fields', $this, 'field', 'term-meta' );
