			...
			'params'                  => array_merge(
				...
				array(
					...
					array(
						...
						'selectors'  => array(
							'{{WRAPPER}}:hover .porto-sicon-title, {{WRAPPER}}:hover .porto-icon, {{WRAPPER}}:hover .porto-sicon-img, {{WRAPPER}}:hover .porto-sicon-description, {{WRAPPER}}:hover .porto-sicon-header p' => 'color: {{VALUE}} !important;',
							'{{WRAPPER}} .porto-sicon-title, {{WRAPPER}} .porto-sicon-header p, {{WRAPPER}} .porto-sicon-description'       => 'transition: color .3s;',
						),
					),
					array(
						'type'        => 'textfield',
					...
					array(
						...
						'param_name' => 'icon_hv_bcolor',
						'dependency'  => array(
							'element' => 'icon_style',
							'value'   => array( 'circle', 'square', 'advanced' ),
						),
						'selectors'   => array(
							'{{WRAPPER}}:hover .porto-icon, {{WRAPPER}}:hover .porto-sicon-img' => 'background-color: {{VALUE}} !important;',
						),
						'group'      => __( 'Icon Style', 'porto-functionality' ),
					),					
					array(
					...
					array(
						'type'        => 'checkbox',
						'heading'     => __( 'Hide On Large Desktop', 'porto-functionality' ),
						'param_name'  => 'large-desktop',
						'value'       => array( __( 'Yes', 'js_composer' ) => 'yes' ),
						'group'      => __( 'Visibility', 'porto-functionality' ),
					),
					array(
						'type'        => 'checkbox',
						'heading'     => __( 'Hide On Desktop', 'porto-functionality' ),
						'param_name'  => 'desktop',
						'value'       => array( __( 'Yes', 'js_composer' ) => 'yes' ),
						'group'       => __( 'Visibility', 'porto-functionality' ),
					),
					array(
						'type'        => 'checkbox',
						'heading'     => __( 'Hide On Tablet Extra', 'porto-functionality' ),
						'param_name'  => 'tablet-extra',
						'value'       => array( __( 'Yes', 'js_composer' ) => 'yes' ),
						'group'       => __( 'Visibility', 'porto-functionality' ),
					),
					array(
						'type'        => 'checkbox',
						'heading'     => __( 'Hide On Tablet', 'porto-functionality' ),
						'param_name'  => 'tablet',
						'value'       => array( __( 'Yes', 'js_composer' ) => 'yes' ),
						'group'       => __( 'Visibility', 'porto-functionality' ),
					),
					array(
						'type'        => 'checkbox',
						'heading'     => __( 'Hide On Mobile Extra', 'porto-functionality' ),
						'param_name'  => 'mobile-extra',
						'value'       => array( __( 'Yes', 'js_composer' ) => 'yes' ),
						'group'       => __( 'Visibility', 'porto-functionality' ),
					),
					array(
						'type'        => 'checkbox',
						'heading'     => __( 'Hide On Mobile', 'porto-functionality' ),
						'param_name'  => 'mobile',
						'value'       => array( __( 'Yes', 'js_composer' ) => 'yes' ),
						'group'       => __( 'Visibility', 'porto-functionality' ),
					),
