		...
		array(
			...
			'params'      => array_merge(
				...
				array(
					...
					array(
						'type'       => 'textfield',
						'heading'    => sprintf( __( 'Animation Name e.g: fadeInUp, fadeIn and so on. Please check this %1$surl%2$s to see the animation name.', 'porto-functionality' ), '<a href="https://www.portotheme.com/wordpress/porto/shortcodes/animations/" target="_blank">', '</a>' ),
					...
					array(
						...
						'value'      => array(
							...
							__( 'Underline 2', 'porto-functionality' ) => 'underline2',
						),
						'std'        => 'scribble',
						'dependency' => array(
							'element'   => 'enable_svghighlight',
