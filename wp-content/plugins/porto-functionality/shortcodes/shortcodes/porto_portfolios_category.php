		...
		array(
			...
			'params'      => array(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .portfolio-item-title, {{WRAPPER}} .thumb-info .thumb-info-title, {{WRAPPER}} .portfolio-parallax h2' => 'color: {{VALUE}} !important;',
						'{{WRAPPER}} .thumb-info-bottom-info:not(.thumb-info-bottom-info-dark) .thumb-info-inner' => 'color: {{VALUE}};',
					),
					'group'      => __( 'Style', 'porto-functionality' ),
				),
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .portfolio-item-title, {{WRAPPER}} .thumb-info .thumb-info-title, {{WRAPPER}} .portfolio-parallax h2' => 'background-color: {{VALUE}} !important;',
					),
					'group'      => __( 'Style', 'porto-functionality' ),
				),
				array(
