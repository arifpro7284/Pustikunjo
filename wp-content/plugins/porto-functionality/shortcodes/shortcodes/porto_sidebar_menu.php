		...
		array(
			...
			'params'       => array(
				...
				array(
					...
					'units'       => array( 'px' ),
					'selectors'   => array(
						'{{WRAPPER}} .sidebar-menu li.menu-item > a > i, {{WRAPPER}} .sidebar-menu li.menu-item > a > svg' => 'font-size: {{VALUE}}{{UNIT}};',
				...
				array(
					...
					'units'      => array( 'px' ),
					'selectors'  => array(
						'{{WRAPPER}} .sidebar-menu li.menu-item > a > i, {{WRAPPER}} .sidebar-menu li.menu-item > a > svg' => ( is_rtl() ? 'margin-left' : 'margin-right' ) . ': {{VALUE}}{{UNIT}};',
					),
					'group'      => __( 'Menu', 'porto-functionality' ),
				),
