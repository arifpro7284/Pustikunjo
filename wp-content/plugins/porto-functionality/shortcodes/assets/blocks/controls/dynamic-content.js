...
const PortoDynamicContentControl = function( {
	...
	if ( 'image' === options.field_type ) {
		...
		tax_fields = [];
		woo_fields = [{ label: __( 'Please select...', 'porto-functionality' ), value: '' }, { label: __( 'Woo Built-in Brands', 'porto-functionality' ), value: 'wc_brand_image' }];
		...
		woo_fields = [{ label: __( 'Please select...', 'porto-functionality' ), value: '' }, { label: __( 'Woo Built-in Brand Url', 'porto-functionality' ), value: 'wc_brand_url' }];
	...
	let source_fields = [{ label: __( 'Please select...', 'porto-functionality' ), value: '' }, { label: __( 'Page or Post Info', 'porto-functionality' ), value: 'post' }, { label: __( 'Porto Meta Box Field', 'porto-functionality' ), value: 'metabox' }, { label: __( 'Advanced Custom Field', 'porto-functionality' ), value: 'acf' }, { label: __( 'Toolset', 'porto-functionality' ), value: 'toolset' }, { label: __( 'Post or Term Meta Field', 'porto-functionality' ), value: 'meta' }, { label: __( 'Taxonomy', 'porto-functionality' ), value: 'tax' },];
	...
	return el(
		...
		isHoverFull ? el(
			'a',
			{ className: 'components-base-control', style: { marginBottom: 15, marginTop: '-0.6rem', width: 'fit-content', background: '#fff', marginLeft: 15, display: 'block' }, target: '_blank', href: 'https://www.portotheme.com/wordpress/porto/business-consulting5/#hover-full-type' },
			label
		) : el(
			'h3',
