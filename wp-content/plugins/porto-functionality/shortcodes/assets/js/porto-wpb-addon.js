( function ( $ ) {
	$( document ).ready( function () {
		 ...
		 * @since 3.1.0
		 */
		if ( typeof vc != 'undefined' && vc.atts && vc.atts.colorpicker ) {
			vc.atts.colorpicker.init = function(param, $field) {
				$(".vc_color-control", $field).each(function() {
					...
					$('<div class="vc_alpha-wrapper"><div class="vc_alpha-container"><label>Alpha: <output class="rangevalue">' + alpha_val + '%</output></label><input type="range" min="0" max="100" value="' + alpha_val + '" name="alpha" class="vc_alpha-field"></div></div>').appendTo(value.addClass("vc_color-picker").find(".iris-picker")),
