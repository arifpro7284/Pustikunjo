...
class Porto_Functionality {
	...
	public function init() {
		...
		! ( class_exists( 'LiteSpeed\Conf' ) && ! empty( LiteSpeed\Conf::cls()->conf( LiteSpeed\Base::O_OPTM_JS_DEFER ) ) ) ) {
			// add async attribute
	...
	protected function define_constants( $active_plugins ) {
		...
		define( 'PORTO_FUNC_VERSION', '3.9.4' );
	...
	public function define_theme_variables() {
		...
		require_once PORTO_SHORTCODES_LIB . 'theme-functions.php';
	}
}
