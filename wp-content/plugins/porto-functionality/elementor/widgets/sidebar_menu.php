	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors'   => array(
					'.elementor-element-{{ID}} .sidebar-menu li.menu-item > a > i, .elementor-element-{{ID}} .sidebar-menu li.menu-item > a > svg' => 'font-size: {{SIZE}}{{UNIT}};',
					'.elementor-element-{{ID}} li.menu-item>a>[class*=" fa-"]'     => 'width: auto;',
				),
				'qa_selector' => '.sidebar-menu li.menu-item > a > i, .sidebar-menu li.menu-item > a > svg',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'.elementor-element-{{ID}} .sidebar-menu li.menu-item > a > i, .elementor-element-{{ID}} .sidebar-menu li.menu-item > a > svg' => "margin-{$right}: {{SIZE}}{{UNIT}};",
				),
			)
		);
