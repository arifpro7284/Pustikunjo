...
class Porto_Elementor_Posts_Grid_Widget extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		if ( isset( $_REQUEST['elementor-preview'] ) ) {
			...
			return array( 'porto-elementor-widgets-js', 'isotope', 'jquery-hover3d', 'jquery-hoverdir', 'porto-pg-hv-overlay', 'porto-hover-image', 'porto-theme-fit-vd', 'porto-video-api' );
		} else {
			return array();
		}
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => sprintf( esc_html__( 'If you select %1$sRecent Posts%2$s, please set "OrderBy" to "Date" and "Order" to "Descending."', 'porto-functionality' ), '<b>', '</b>' ),
		...
		$this->add_control(
			'product_visibility',
			array(
				'label'     => __( 'Product Visibility', 'porto-functionality' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => array(
					'visible' => __( 'Shop and search results', 'porto-functionality' ),
					'catalog' => __( 'Shop only', 'porto-functionality' ),
					'search'  => __( 'Search results only', 'porto-functionality' ),
					'hidden'  => __( 'Hidden', 'porto-functionality' ),
					'any'     => __( 'Any', 'porto-functionality' ),
				),
				'condition' => array(
					'source'    => '',
					'post_type' => 'product',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'   => array(
					'.elementor-element-{{ID}} .sort-source a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'qa_selector' => '.sort-source li:first-child',
			)
		);
		$this->add_control(
			'filter_it_radius',
			array(
				...
				'selectors'   => array(
					'.elementor-element-{{ID}} .sort-source a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->add_control(
