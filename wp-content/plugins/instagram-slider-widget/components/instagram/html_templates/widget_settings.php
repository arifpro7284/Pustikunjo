...
<div class="jr-container">
    ...
    <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'feed_id' ) ); ?>"><?php _e( 'Instagram feed', 'instagram-slider-widget' ); ?>
            :</label>
        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'feed_id' ) ); ?>"
